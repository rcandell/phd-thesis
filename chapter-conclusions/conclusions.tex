...
To support the research performed for this contribution, a testbed has been constructed. This testbed was described in Chapter~\ref{chapter:graphdb} and is illustrated in the photo provided in Fig.~\ref{gdbappl:fig::workcell}.  The network design of the testbed is shown in Fig.~\ref{fig:concl:experiment-design} CONTINUE
