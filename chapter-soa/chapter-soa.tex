...
Give introduction AND State that the author (ME) has contributed to this body of work

\subsection{ISA Requirements Perspective}
...
\subsection{ETSI Requirements Perspective}
...
\section{An Industry Requirements Perspective}
...
\begin{table}[!tb]
	...
	\begin{tabular}{|p{7.5em}|p{4.215em}|p{4.215em}|p{4.215em}|p{4.215em}|}
		\toprule
		\textbf{Scenario} & \textbf{\# of nodes} & \textbf{Update rate} & \textbf{Goodput} & \textbf{System range} \\
		\midrule
		Building Automation & 102-103 & 10-1 Hz & 103-104 bps & 101-102 m \\
		\midrule
		Process Automation & 102-103 & 101 Hz & 105-106 bps & 101-102 m \\
		\midrule
		Factory Automation & 102-103 & 103 Hz & 107-108 bps & 101-102 m \\
		\midrule
		Power Systems Automation & 101-102 & 104 Hz & 107-108 bps & 102-103 m \\
		\midrule
		Power Electronics Control & 102-103 & 105 Hz & 109-1010 bps & 101-102 m \\
		\bottomrule
	\end{tabular}%
...
\subsection{NIST Validated Requirements Perspective}
