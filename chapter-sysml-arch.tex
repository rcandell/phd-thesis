...
\begin{figure}
	\centering
	\includegraphics[width=0.95\columnwidth]{./chapter-sysml/diagrams/fbd-system}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.95\columnwidth]{./chapter-sysml/diagrams/par__Radio_Channel__Radio_Channel}%
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.95\columnwidth]{./chapter-sysml/diagrams/par__Service__Service}%
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.95\columnwidth]{./chapter-sysml/diagrams/bdd__Application__Application}
...
\begin{figure}[tbp]
	\centering
	\subfloat[\label{fig:iwn:bdd}]{\includegraphics[width=0.99\columnwidth]{./chapter-sysml/diagrams/bdd__Network__Network}}
	\hfill
...
\begin{figure}[tbp]
	...
	\subfloat[Block definition diagram of the Robot Controller\label{fig:robotcontroller:bdd}]{%
		\includegraphics[width=0.95\columnwidth]{./chapter-sysml/diagrams/bdd__Robotics__RobotController}
	}
	\hfill
	\subfloat[Internal block diagram of the Robot Controller\label{fig:robotcontroller:ibd}]{%
		\includegraphics[width=0.95\columnwidth]{./chapter-sysml/diagrams/ibd__RobotController__RobotController}
	}  
