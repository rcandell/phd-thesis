...
\begin{figure}[ht]
	...
	\caption{\gls{bdd}~\protect\subref{sysml:fig:wirelessdevice:bdd} and the \gls{ibd}~\protect\subref{sysml:fig:wirelessdevice:ibd} of Wireless Device.}
	\label{sysml:fig:wirelessdevice:full}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{The BDD~\protect\subref{sysml:fig:robotcontroller:bdd}, \gls{ibd}~\protect\subref{sysml:fig:robotcontroller:ibd} of the Robot Controller.}
...
\begin{figure*}[tbp]
	...
	\caption{\gls{ibd} of a workcell employing multiple networks in collaborative robot operation coexisting with robot force limiting inspection station.}
