...
\declarethesis[This is the sub-title]{This is my thesis title}{21 June 2020}{Dijon}{XXX}
...
The author would like express his gratitude to his beautiful daughter, Erin, for all of her generous support during a difficult time.
...
\subsection{Energy Efficiency Applicaiton for Battery-powered Devices }
...
\section{Motivation for Test Methods and Architectures }
...
\section{Wireless Channel Characterization}

\section{Interference}

\subsection{Interference Impacts}

\subsection{Interference Mitigation}

\subsection{Interference Monitoring}

\subsection{Spectral Awareness in the Work-cell}

\section{Existing Testbeds and Test Methods}
explain that test methods are not investigated fully in literature
include wireless and cyber-security as examples
academic problems versus real-world problems

\chapter{Testbed Approach}
Explain the testbed, purpose, and use cases
\section{Force Seeking Apparatus}
\section{Machine Tending Use Case}
\section{Elaborated Collision Avoidance}
...
The definition~\ref{def:athesis} illustrates the proposition of a definition.

\begin{definition}[A Thesis] \label{def:athesis}
Book presented to a university jury for a doctorate.
\end{definition}
