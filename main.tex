...
\begin{figure}[!tbp]
	\begin{center}
		\includegraphics[options]{images/intro}
		\label{fig:intro:isa95}
		\caption{The ISA-95 model divides production systems into 5 levels, based on the Purdue Enterprise Reference Architecture (PERA) model.}
	\end{center}
\end{figure}
