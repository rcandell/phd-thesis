...
% commands for better float placement
...
\usepackage[automake,nomain,style=long,nonumberlist,acronym]{glossaries}
\makeglossaries
...
\declarethesis[]{Performance Estimation, Testing, and Control of Cyber-Physical Systems Employing Non-Ideal Communications Networks}{28 Sep 2020}{Dijon}{XYZ}
...
\addjury{Nejib}{MOALLA}			{President}				{Professeur à l'University Lumi\'ere Lyon 2}
...
\addjury{Salima}{BENBERNOU}		{Examinatrice}			{Université de Paris }
\addjury{Marinette}{SAVONNET}	{Examinatrice}			{Université de Bourgogne Franche-Comté }
