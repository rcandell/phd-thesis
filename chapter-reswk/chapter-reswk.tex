...
\begin{emphbox}
	A clear need for accessible test methods exists in the wireless cyber-physical systems space in which the tester need not be an expert in wireless communications or radio wave propagation.
\end{emphbox}
