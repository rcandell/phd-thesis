...
%\baselinestretch{1.1}
	...
	\title{Industrial Wireless: Problem Space, Success Considerations, Technologies, and Future Direction}
	...
	\author{
       ...
       and $\mbox{Mohamed Kashef}$,~\IEEEmembership{Member,~IEEE}
        
		% <-this % stops a space
		%\thanks{Manuscript received 5 January 2012; revised 15 May 2012.}
       \thanks{R. Candell is with Intelligent Systems Division, Engineering Laboratory, National Institute of Standards and Technology, Gaithersburg, MD, USA 20899 (e-mail: richard.candell@nist.gov).}
		
		\thanks{M. Kashef is an associate researcher with Advanced Networking Division, Information Technology Laboratory, National Institute of Standards and Technology, Gaithersburg, MD, USA 20899 (e-mail: mohamed.hany@nist.gov).} 
	...
	%{LIU \MakeLowercase{\textit{et al.}}: A Simulation Framework for Industrial Wireless Networks and Process Control Systems}
	...
	\begin{IEEEkeywords}
    industrial wireless, industrial communication, industrial control, networked control, manufacturing, cyber-physical systems, taxonomy
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figs/probsp}
...
%  Okay, here it is~\cite{chao2015software}
  
%   Discussion points:
  
% \begin{enumerate}
%   \item Current work and why
%   \item Guidelines effort
%   \item Cyber-physical systems simulations and testbed activities
% \end{enumerate}
...
%     \begin{IEEEbiographynophoto}{Richard Candell}
%     Biography text here.
%     \end{IEEEbiographynophoto}

%     % if you will not have a photo at all:
%     \begin{IEEEbiographynophoto}{Mohamed Hany}
%     Biography text here.
%     \end{IEEEbiographynophoto}
...
%     \begin{IEEEbiographynophoto}{Jeanne Quimby}
%     Biography text here.
%     \end{IEEEbiographynophoto}

%     \begin{IEEEbiographynophoto}{Kate Remley}
%     Biography text here.
%     \end{IEEEbiographynophoto}
